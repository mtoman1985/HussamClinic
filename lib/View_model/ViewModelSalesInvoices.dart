...
class ViewModelSalesInvoices {
  ...
  String AccountingGroups_select='المرضي';
  ...
  void AddNewInvoices() {
    ...
    if(AccountingPerson_select_name=='o'){
      ...
      dbJournals.addjournals(
        ...
        ' فاتورة بيع رقم $MaxInvoices / $AccountingPerson_select_name',
      );

      /// add Invioces
     // print('add Invioces 55555555555555555555555');
...
// ' فاتورة شراء رقم'
      ...
      /// 5001	نجاح دياب الأغا	90.0	0	 فاتورة بيع رقم 1 / نجاح دياب الأغا	شيكل	1	90.0
      if(remaining>0) {
      ...
      if(payment>0){
        dbJournalDetails.addjournalDetails(
            ...
            "0",
            ' إيصال قبض  $MaxVouchers / $AccountingPerson_select_name',
            currencySelect,
            rate.toString(),
            numberFormat.format(rate*remaining)
        );
        // addVouchers   إضافة ايصال قبض
