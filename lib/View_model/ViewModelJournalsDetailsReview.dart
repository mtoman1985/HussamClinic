...
class ViewModelJournalsDetailsReview {
  ViewModelJournalsDetailsReview.impty(){
    this.AccountingTo_select_name='f';
    this.dateDate = DateTime.now();
    this.Selectedtime = TimeOfDay.now();
    this.AccountingGroups_select='المرضي';
    this.AccountingPerson_select_name='o';
    this.AccountingPerson_select_id='o';
    this.AccountingTo_select_id='120101';
    this.AccountingTo_select_name='صندوق العيادة';
    this.currencySelect = "شيكل";
    this. rate = 1;
    this.amount=0; //'قيمة الفاتورة'
    this.disscount=0; //'قيمة الخصم
    this.amount_all=0; //'قيمة الفاتورة الكلية'
    this.payment=0; //المدفوع
    this.payment_currency="شيكل";
    this.remaining=0;//المبلغ المتبقي
    this.saving=false;
    this.EditeMode=false;
    rows.clear();
    this.Maxjournals =VMGlobal.Maxjournals;
    this.MaxInvoices=VMGlobal.MaxInvoices;
    this.MaxVouchers=VMGlobal.MaxVouchers;
  }
  /// Styles and Color
