class AccoutingTreeModel {
  ...
  AccoutingTreeModel(dynamic obj) {
     _id =obj["AT_id"] as int;
    _name =obj["AT_name"];//'رقم الزبون'
    _branch_no =obj["AT_branch_no"];//'اسم الزبون أو المورد'
    _father_no =obj["AT_father_no"];//'قيمة الفاتورة'
    _branch_originalId =obj["AT_branch_originalId"];// 'رقم القيد'
  }
