...
class InvoicesModel {
  ...
  String _date =  DateTime.now().isAtStartOfDay.toString();  // 'التاريخ'
  String _time =   DateTime.now().isAtStartOfDay.toString();  // 'الوقت'
  ...
  InvoicesModel(dynamic obj) {
    ...
    _account_name =obj["invoice_account_name"];//'اسم الزبون أو المورد'
     ...
     _accountingTo_name =obj["invoice_accountingTo_name"];//'اسم الزبون أو المورد'
 ...
 "invoice_accountingTo_no": _accountingTo_no ,//'رقم الزبون'
   "invoice_accountingTo_name": _accountingTo_name,//'اسم الزبون أو المورد'
