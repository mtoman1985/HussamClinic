...
class _PageAddCostumersState extends State<PageAddCostumers> {
  int paint_id=1;
  var _costumer_name,  _costumer_mobile,_costumer_fileNo;
  var _costumer_resone;
  var _costumer_worries="نعم";
  var _costumer_place, _costumer_sex='ذكر';
  String _costumer_birthDate= '${projectStartDate.day}/${projectStartDate.month}/${projectStartDate.year}';
  ...
  addCostumers(context) async {
    ...
    if (formdata!.validate()) {
      ...
      if(repeatCheck==false){
        ...
        dbPatient.addPatient(_costumer_name,
            _costumer_mobile,_costumer_sex,
            _costumer_status,_costumer_birthDate,
            _costumer_fileNo,_costumer_place,
            _costumer_resone,_costumer_worries);
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          action: SnackBarAction(
            ...
            onPressed: () {
              DbPatient dbPatient = DbPatient();
              dbPatient.updateFileNoPatient(_costumer_name,_costumer_mobile,_costumer_sex,_costumer_status,
                  _costumer_birthDate,_costumer_fileNo,_costumer_place,_costumer_resone,_costumer_worries);
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text(
  ...
  addCostumerhealth(context) async {
    ...
    if (formdata!.validate()) {
      ...
      if(repeatCheckhealth==false){
        ...
        dbPatientHealth.addPatientHealth(paint_id.toString(),_costumer_health,
            _costumer_sensitive.toString(), _costumer_sensitive_Ex,
            _costumer_surgical.toString(), _costumer_surgical_Ex,
            _costumer_haemophilia.toString(), _costumer_haemophilia_Ex,
            _costumer_oralDiseases, _costumer_smoking.toString(),
            _costumer_pregnant.toString(), _costumer_pregnant_Ex,
            _costumer_lactating.toString(), _costumer_lactating_Ex,
            _costumer_contraception.toString(), _costumer_contraception_Ex
        );
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text(
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          action: SnackBarAction(
            ...
            onPressed: () {
              DbPatientHealth dbPatientHealth = DbPatientHealth();
              PatienHealthtModel patienHealthtModel  =_PatienHealthtModel.empty();
              ...
              patienHealthtModel.contraception=_costumer_contraception.toString();
              patienHealthtModel.contraception_Ex=_costumer_contraception_Ex;

              dbPatientHealth.updatePatientHealth( int.parse(paint_id.toString()),patienHealthtModel);
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text(
                  ' تم تعديل بيانات المريض بنجاح ',
                  style: TextStyle(fontSize: 20,fontWeight:FontWeight.bold),
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () async {
                                  ...
                                  setState(() {
                                    _costumer_birthDate =  '${date.day}/${date.month}/${date.year}';
                                    projectStartDate=date;
                                  } );
                                  // print(date);
                                },
                ...
                Center(
                  child: TextButton(
                      ...
                      const Row(
                        ...
                        children: [
                          Text('احفظ البيانات ',style: TextStyle(color:Color(0xFF167774),fontSize: 20),),
              ...
              children: [
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment :_costumer_sensitive==true? MainAxisAlignment.spaceBetween: MainAxisAlignment.spaceEvenly ,
                          children: [
                    ...
                    Flexible(
                      ...
                      child:_costumer_sensitive==true? TextFormField(
                        onSaved: (val) {
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment :_costumer_surgical==true? MainAxisAlignment.spaceBetween: MainAxisAlignment.spaceEvenly ,
                          children: [
                    ...
                    Flexible(
                      ...
                      child:_costumer_surgical==true? TextFormField(
                        onSaved: (val) {
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment :_costumer_haemophilia==true? MainAxisAlignment.spaceBetween: MainAxisAlignment.spaceEvenly ,
                          children: [
                    ...
                    Flexible(
                      ...
                      child:_costumer_haemophilia==true? TextFormField(
                        onSaved: (val) {
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment :_costumer_drugs==true? MainAxisAlignment.spaceBetween: MainAxisAlignment.spaceEvenly ,
                          children: [
                    ...
                    Flexible(
                      ...
                      child:_costumer_drugs==true? TextFormField(
                        onSaved: (val) {
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Flexible(
                      ...
                      child:_costumer_pregnant==true? TextFormField(
                        onSaved: (val) {
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Flexible(
                      ...
                      child:_costumer_lactating==true? TextFormField(
                        onSaved: (val) {
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Flexible(
                      ...
                      child:_costumer_contraception==true? TextFormField(
                        onSaved: (val) {
                ...
                Center(
                  child: TextButton(
                        ...
                        setState(() {
                          if (repeatCheck==false){
                            ...
                            if (repeatCheckhealth==false){
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                content: Text(
                                  'لم يتم إضافة البيانات الصحية هل تريد تعديل البينا',
                                  style: TextStyle(fontSize: 20,fontWeight:FontWeight.bold),
                                ),
                                duration: Duration(seconds: 4),
                              ));
                      ...
                      style:repeatCheckhealth==false?FirstClick:SecondClick,
                      child:
                      const Row(
                        mainAxisAlignment : MainAxisAlignment.center,
                        children: [
