              ...
              children: [
                pw.Padding(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Text(
                        ' رقم الفاتورة : ${VMSalesInvoice.MaxInvoices}', style: pwTableHeadingTextStyle(fontPage,14),
                      ),
                ...
                pw.Padding(
                  ...
                  child: pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.center,
                      children: [
                        pw.Text(" رقم المريض : ${VMSalesInvoice.AccountingPerson_select_id}"
                            , style: pwTableHeadingTextStyle(fontPage,14)),
                        pw.Text(
                          ' الساعة: ${VMSalesInvoice.Selectedtime.hour}:${VMSalesInvoice.Selectedtime.minute}', style: pwTableHeadingTextStyle(fontPage,14),
                        ),
                      ]),
                ),
                pw.Padding(
                  ...
                  child: pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.center,
                      children: [
                        pw.Text(" اسم المريض : ${VMSalesInvoice.AccountingPerson_select_name}"
                            , style: pwTableHeadingTextStyle(fontPage,14)),
                        pw.Text(
                          ' التاريخ: ${VMSalesInvoice.dateDate.day}/${VMSalesInvoice.dateDate.month}/${VMSalesInvoice.dateDate.year}',  style: pwTableHeadingTextStyle(fontPage,14),
                        ),
              ...
              children: [
                pw.Padding(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Text(
                        '    الفاتورة الإجمالية : ${VMSalesInvoice.amount_all} ${VMSalesInvoice.currencySelect} ', style: pwTableHeadingTextStyle(fontPage,14,color: const PdfColor(1,0,0,.8)),
                      ),
                    ],
                  ),
                ),
      ...
      return
        pw.Padding(
          ...
          child: pw.Column(
              ...
              children: [
                pw.Text(
                  '   قيمة الخصم : ${VMSalesInvoice.disscount} ${VMSalesInvoice.currencySelect} ', style: pwTableHeadingTextStyle(fontPage,14),
                ),
                pw.Text(
                  '  المبلغ المتبقي   : ${VMSalesInvoice.remaining} ${VMSalesInvoice.currencySelect} ', style: pwTableHeadingTextStyle(fontPage,14,color: PdfColor(1,0,0,.8)),
                ),
              ]),
        );
    }
    ...
    if(VMSalesInvoice.payment>0) {
      return pw.Padding(
        ...
        child: pw.Column(
            ...
            children: [
              pw.Text(
                '  مبلغ الفاتورة : ${VMSalesInvoice.amount} ${VMSalesInvoice
                    .currencySelect} ',
                style: pwTableHeadingTextStyle(fontPage, 14),
              ),
              pw.Text(
                '  المبلغ المدفوع نقداً : ${VMSalesInvoice
                    .payment} ${VMSalesInvoice.currencySelect} ',
